...
public class KafkaMainGUI extends JFrame implements ActionListener {
	...
	public static SSLParams sp1 = new SSLParams();
	public static SSLParams sp2 = new SSLParams();
	...
	private void init() {
		...
		// 验证ssl
		jlb17 = new JLabel("验证SSL：");
		jlb17.setBounds(20, 180, 100, 25);
		jp1.add(jlb17);

		jcbox1 = new JCheckBox("开启验证SSL", false);
		jcbox1.setBounds(73, 180, 150, 25);
		jp1.add(jcbox1);
		jcbox1.setSelected(km.isOpenSSL());
		// 监听
		jcbox1.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				if (jcbox1.isSelected()) {
					KafkaSSLJD ksjd = new KafkaSSLJD(sp1, 1, jcbox1);
				}
			}
		});
		...
		// 验证ssl
		jlb18 = new JLabel("验证SSL：");
		jlb18.setBounds(20, 100, 100, 25);
		jp2.add(jlb18);

		jcbox2 = new JCheckBox("开启验证SSL", false);
		jcbox2.setBounds(73, 100, 150, 25);
		jp2.add(jcbox2);
		jcbox2.setSelected(kmm.isOpenSSL());
		// 监听
		jcbox2.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				if (jcbox2.isSelected()) {
					KafkaSSLJD ksjd = new KafkaSSLJD(sp2, 2, jcbox2);
				}
			}
		});
	...
	private BaseMsg getBaseMsg() {
		...
		baseMsg.setOpenSSL(jcbox1.isSelected());
		baseMsg.setSslp(sp1);
		return baseMsg;
	}
	...
	private BaseMsg getBaseMsg2() {
		...
		baseMsg.setOpenSSL(jcbox2.isSelected());
		baseMsg.setSslp(sp2);
		return baseMsg;
	}
